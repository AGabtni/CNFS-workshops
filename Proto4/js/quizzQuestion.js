class Question {
    ...
    updateQuizzList() {
        ...
        for (var c = 0; c < this.choiceListElements.length; c++) {
            ...
            this.choiceListElements[c].querySelectorAll(".feedback-img")[0].style.opacity = 0;
            this.choiceListElements[c].parentNode.querySelectorAll("#selectImage")[0].style.opacity = 0;
        ...
        for (var c = 0; c < this.selectedChoices.length; c++) {
            ...
            this.choiceListElements[this.selectedChoices[c]].parentNode.querySelectorAll("#selectImage")[0].src = "./img/select.png";
            this.choiceListElements[this.selectedChoices[c]].parentNode.querySelectorAll("#selectImage")[0].style.opacity = 1.0;
        }

        for (var c = 0; c < this.incorrectChoices.length; c++) {

            this.choiceListElements[this.incorrectChoices[c]].classList.add("incorrect");
            this.choiceListElements[this.incorrectChoices[c]].parentNode.querySelectorAll(".feedback-img")[0].src = "./img/cross.png";
            this.choiceListElements[this.incorrectChoices[c]].parentNode.querySelectorAll(".feedback-img")[0].style.opacity = 1.0;
        }
        for (var c = 0; c < this.correctChoices.length; c++) {

            this.choiceListElements[this.correctChoices[c]].classList.add("correct");
            this.choiceListElements[this.correctChoices[c]].parentNode.querySelectorAll(".feedback-img")[0].src = "./img/tick.png";
            this.choiceListElements[this.correctChoices[c]].parentNode.querySelectorAll(".feedback-img")[0].style.opacity = 1.0;
